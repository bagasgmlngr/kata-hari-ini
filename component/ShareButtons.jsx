...
export default function ShareButtons({ quote }) {
    ...
    const [activeTab, setActiveTab] = useState('social'); // 'social' or 'copy'
    ...
    const shareLinks = {
        ...
        instagram: `javascript:void(0)` // Instagram tidak memiliki API sharing langsung
    };
